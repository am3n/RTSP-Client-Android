...
class YuvToRgbTask : public Task {
    ...
    void processData(int threadIndex, size_t startX, size_t startY, size_t endX, size_t endY) override;
...
void YuvToRgbTask::processData(int /* threadIndex */, size_t startX, size_t startY, size_t endX, size_t endY) {
